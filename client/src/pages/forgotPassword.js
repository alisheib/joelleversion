...
import imgSVG from '../assets/img/fp.svg';
							...
							<div className="container">
								<div className="row align-items-center">
									<div className="col-lg-7 col-12">
										<img className="img-fluid" src={imgSVG} alt="forgot password" />
									</div>
												...
												<div className="col-15">
													<div>
														...
														<form id="contact-form">
															...
															</div> <Link to="#" className="btn btn-primary btn-block">Send Me Reset Link</Link>
														</form>
														<div className="mt-4"><Link to="/sign-ing" class="link-title">Back to sign in</Link>
														</div>
													</div>
												</div>
											</div>
