								...
								<div className="card-box">
									<ul className="nav nav-pills navtab-bg">
										<li className="nav-item">
											...
											<Link to="/Course/CourseInfoDesc" data-toggle="tab" aria-expanded="false" className="nav-link "><i className="mdi mdi-face-profile mr-1" />About the course</Link>
										</li>
										<li className="nav-item">

											<Link to="/Course/CourseInfoSet" data-toggle="tab" aria-expanded="true" className="nav-link ml-0 active"><i className="mdi mdi-settings-outline mr-1" />Settings</Link>
										</li>
									</ul>
